          ...
          <div className="mt-3 pt-3 border-t border-gray-100 mb-4 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3 text-sm text-gray-700">
              ...
              {solution.moeilijkheidsgraad && (
                <div className="flex items-start">
                  <svg className="h-4 w-4 text-amber-600 mr-2 mt-0.5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M8.485 2.495c.673-1.167 2.357-1.167 3.03 0l6.28 10.875c.673 1.167-.17 2.625-1.516 2.625H3.72c-1.347 0-2.189-1.458-1.515-2.625L8.485 2.495zM10 5a.75.75 0 01.75.75v3.5a.75.75 0 01-1.5 0v-3.5A.75.75 0 0110 5zm0 9a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" /></svg>
                  <div className="text-gray-800">
                    <span className="font-semibold mr-1">Moeilijkheidsgraad:</span>
                    <span>{solution.moeilijkheidsgraad}</span>
                  </div>
                </div>
              )}
