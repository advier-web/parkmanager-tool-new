            ...
            <View style={{ marginTop: 12 }}>
              ...
              {renderRichText(
                [
                  ...
                  '- Peil het draagvlak: Voer enquêtes of interviews uit onder medewerkers om hun interesse en bereidheid te meten voor deelname aan collectieve vervoersoplossingen. Zorg ervoor dat dit ook gericht is op de praktische aspecten zoals routes, tijden en kosten.',
