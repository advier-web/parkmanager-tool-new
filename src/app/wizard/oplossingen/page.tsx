        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-3">
            <div className="bg-white rounded-lg p-8 shadow-even">
              ...
              <p className="mb-6">
                Op basis van de door u geselecteerde aanleidingen zijn onderstaande collectieve vervoersoplossingen gesorteerd. Om verder te gaan selecteert u één collectieve vervoersoplossing. Indien u COVER-subsidie aanvraagt: oplossingen worden gevraagd in de <a href="https://www.rvo.nl/subsidies-financiering/cover" target="_blank" rel="noreferrer noopener" className="text-blue-600 underline">COVER-subsidie aanvraag</a> in deel 5.
              </p>
