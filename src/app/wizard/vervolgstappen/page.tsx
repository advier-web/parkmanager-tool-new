        ...
        <div className="lg:col-span-3 space-y-8">
          ...
          <div className="bg-white rounded-lg p-8 shadow-even">
            ...
            <ul className="list-disc pl-5 space-y-1 text-gray-700">
              ...
              <li>Indien niet aanwezig, voer een mobiliteitsscan uit. In elke regio van Nederland staan mobiliteitsnetwerken klaar om u gratis te helpen. De regionale netwerken bieden u onafhankelijk advies, afgestemd op uw organisatiedoelen en kenmerken. Vaak bieden de netwerken de optie om kosteloos uw huidige mobiliteitsbeleid te onderzoeken via een mobiliteitsmakelaar. Meer informatie hierover vindt u <a className="text-blue-600 underline hover:text-blue-800" href="https://www.rvo.nl/onderwerpen/start-met-verduurzamen-werkgebonden-personenmobiliteit/regionale-netwerken" target="_blank" rel="noreferrer noopener">op de website van het RVO</a>. Het alternatief is dit onderdeel te maken van de inkoop of een risico te lopen in het gebruik in de praktijk te toetsen.</li>
